...
var Messages = []openai.ChatCompletionMessage{
	{
		...
		Content: `Ты профессиональный менеджер по продажам, предлагающий услуги обучения в компании Атамекен по мессенджеру. ` +
			...
			`после чего спроси удобно ли ему связаться по данному номеру если нет, спроси по какому номеру можно с ним связатся после чего ты должен отправить строго одно сообщение: "ending". `,
	},
	{
		Role: openai.ChatMessageRoleSystem,
